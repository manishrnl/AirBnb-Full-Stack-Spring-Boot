...
VALUES (1, 'Manish Kumar', 'manishrajrnl@zohomail.in', 'Manish@123456', '2004-05-15','MALE') ,
 (2, 'Manish Kumar', 'manish.rnl@zohomail.in', 'Manish@123456', '2004-05-15','MALE') ON
...
VALUES (1, 'Ocean Breeze Resort', 'Goa',
        ...
        true, 2, '123 Beach Road, Calangute', 'stay@oceanbreeze.com', '15.54, 73.75',
       ...
       (4, 'Urban Chic Suites', 'Bangalore',
        ...
        4.2, true, 2, '10 MG Road, Indiranagar', 'hello@urbanchic.com', '12.97, 77.59',
        '+91-9876543213', NOW(), NOW()),

       (5, 'Urban Chic Suites', 'Bangalore',
        'Modern, high-tech apartments designed for digital nomads and business travelers.',
        4.2, true, 1, '10 MG Road, Indiranagar', 'hello@urbanchic.com', '12.97, 77.59',
        '+91-9876543213', NOW(), NOW()),

       (6, 'Urban Chic Suites', 'Bangalore',
        'Modern, high-tech apartments designed for digital nomads and business travelers.',
        4.2, true, 2, '10 MG Road, Indiranagar', 'hello@urbanchic.com', '12.97, 77.59',
        '+91-9876543213', NOW(), NOW()),

       (7, 'Urban Chic Suites', 'Bangalore',
        'Modern, high-tech apartments designed for digital nomads and business travelers.',
        4.2, true, 1, '10 MG Road, Indiranagar', 'hello@urbanchic.com', '12.97, 77.59',
        '+91-9876543213', NOW(), NOW()),

       (8, 'Serene Lake House', 'Udaipur',
        'Peaceful retreat on the banks of Lake Pichola with breathtaking sunset views.', 4.7,
        true, 2, 'Lake Side Drive, Hanuman Ghat', 'bookings@serenelake.com', '24.58, 73.68',
...
VALUES (1, 1, 'Sunset King Suite', 'Ocean view with a king-sized bed.', 'Suite', 'Goa', 2, 5,
       ...
       (6, 6, 'Poolside Cabana', 'Quick access to the main pool area.', 'Standard', 'Goa', 2,
       ...
       (8, 6, 'Economy Backpacker', 'Simple, clean, and budget-friendly.', 'Economy', 'Goa', 1,
...
-- Hotel 2: Manali Rooms
       ...
       (11, 6, 'River Side Cottage', 'Hear the sound of the Beas River.', 'Cottage', 'Manali',
       ...
       (14, 6, 'Twin Forest Room', 'Two separate beds for friends/family.', 'Standard',
...
-- Hotel 3: Jaipur Rooms
       ...
       (20, 7, 'Saffron Luxury Room', 'Equipped with premium silk linens.', 'Premium',
       ...
       (23, 7, 'Gateway Single', 'Perfect for solo history buffs.', 'Economy', 'Jaipur', 1, 6,
...
-- Hotel 4: Bangalore Rooms
       ...
       (27, 8, 'Business King', 'Soundproof walls for quiet meetings.', 'Executive',
       ...
       (30, 8, 'Compact Pod', 'Privacy and comfort for short stays.', 'Pod', 'Bangalore', 1,
...
-- Hotel 5: Udaipur Rooms
       ...
       (36, 8, 'Poolside Retreat', 'Just steps away from the pool.', 'Standard', 'Udaipur', 2,
       ...
       (39, 8, 'Cozy Courtyard', 'Inward facing, very quiet.', 'Economy', 'Udaipur', 2, 5, 1,
...
(6, 'https://images.unsplash.com/photo-1519046904884-53103b34b206'),
-- Hotel 2 (Manali)
...
(3,
 'https://images.unsplash.com/photo-1496417263034-38ec4f0b665a?auto=format&fit=crop&q=80&w=1000'),
-- Hotel 4 (Bangalore)
...
(8, 'https://images.unsplash.com/photo-1518780664697-55e3ad937233'),
...
VALUES (1, 'https://images.unsplash.com/photo-1590490360182-c33d57733427'),
       ...
       (6, 'https://images.unsplash.com/photo-1595576508898-0ad5c879a061'),
       ...
       (6, 'https://images.unsplash.com/photo-1594741160417-066e41442f23'),
       ...
       (7, 'https://images.unsplash.com/photo-1590073242678-70ee3fc28e8e'),
       (3, 'https://images.unsplash.com/photo-1582719471384-894fbb16e024'),

       (4,
        'https://images.unsplash.com/photo-1541339907198-e08759dfc3ef?auto=format&fit=crop&q=80&w=1000'),
       (4,
       ...
       (4,
        'https://images.unsplash.com/photo-1561501900-3701fa6a0864?auto=format&fit=crop&q=80&w=1000'),
       (4,
       ...
       (8, 'https://images.unsplash.com/photo-1502672023488-70e25813efdf'),
